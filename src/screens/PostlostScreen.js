    ...
    return (
      <Container>
        <Content>
          ...
          <Left>
            <Body >
              <Text style={styles.lableTopicpostlost}>  3. รายละเอียด</Text>
            </Body>
          </Left>
          ...
          <Left>
            <Body >
              <Text style={styles.lableTopicpostlost3}> 4. เพิ่มรูปภาพ</Text>
            </Body>
          </Left>
          ...
          <Left>
            <Body >
              <Text style={styles.lableTopicpostlost}> 5. เพิ่มสถานที่</Text>
            </Body>
          </Left>
          ...
          <Button onPress={this.addPostlost} style={styles.addimgButton3} full success>
